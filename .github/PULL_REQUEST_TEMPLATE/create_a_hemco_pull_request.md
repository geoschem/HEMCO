...
<!--- Place an `x` in all the boxes that apply -->
* [ ] Difference test with HEMCO in GEOS-Chem
* [ ] Difference test with HEMCO standalone
* [ ] Difference test with HEMCO in external models
* [ ] GEOS-Chem benchmark simulation(s) using this HEMCO version
